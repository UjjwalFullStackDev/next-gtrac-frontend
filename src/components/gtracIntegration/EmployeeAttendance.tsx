...
export default function EmployeeAttendance() {
  ...
  const processAttendance = (attendance: Attendance[], day: Date): ProcessedAttendance | undefined => {
    ...
    // Check if punchOutTime is earlier than punchInTime
    ...
    return {
      ...
      // punchOut: lastPunchOut?.punchTime || "",
    ...
    const exportData = employeeAttendanceData
      ...
      .flatMap((employee) => {
        ...
        return attendanceRecords.map((att) => ({
          ...
          "Punch In Location": att.punchLocation || "-",
          "Punch Out Location": att.punchLocation || "-",
  ...
  return (
    <div className="p-4">
      ...
      <div className="h-[82vh] rounded-lg border-2 border-dashed border-gray-300 bg-gray-50 p-2">
        <div className="h-[78vh] bg-white border border-gray-50 shadow rounded-md overflow-hidden">
